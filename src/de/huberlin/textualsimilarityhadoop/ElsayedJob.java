...
public class ElsayedJob extends Configured implements Tool {
  private static final Logger log = Logger.getLogger(ElsayedJob.class);
  ...
  public static class JoinReducer extends Reducer<BytesWritable, BytesWritable, LongWritable, LongWritable> {
  ...
  public int run(String[] args) throws Exception {
    ...
    job1a.setJarByClass(ElsayedJob.class);
    ...
    job2a.setJarByClass(ElsayedJob.class);
    ...
    job2a.setOutputValueClass(IntWritable.class);
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new ElsayedJob(), args);
  }

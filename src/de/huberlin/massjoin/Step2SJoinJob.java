 ...
 * @author fabi
 */
public class Step2SJoinJob extends Configured implements Tool {
...
//    conf.set("mapreduce.map.output.compress", "true");
    ...
    job2.setJarByClass(Step2SJoinJob.class);
    ...
    if (onlyStatistics) {
      job2.setReducerClass(SjoinStatisticsReducer.class);
  ...
  public static void main(String[] args) throws Exception {
    ToolRunner.run(new Configuration(), new Step2SJoinJob(), args);
  }

  public static class SjoinStatisticsReducer extends Reducer<IntWritable, Text, Text, NullWritable> {

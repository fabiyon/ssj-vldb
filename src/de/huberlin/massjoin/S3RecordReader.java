 ...
 */
public class S3RecordReader extends RecordReader<IntPairWritable, Text> {
  ...
  private IntPairWritable key = new IntPairWritable();
...
//                + (pos - newSize));
  ...
  private void createKeyValue(Text recordLine) {
    ...
    key.set(Integer.parseInt(fields[0]), 0);
...
// txnRecord = recordLine;            
   ...
   */
  @Override
  public IntPairWritable getCurrentKey() throws IOException,
